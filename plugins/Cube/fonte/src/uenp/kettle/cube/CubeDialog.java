...
import uenp.kettle.dimensao.Messages;
...
public class CubeDialog extends BaseStepDialog implements StepDialogInterface {
	...
	public String open() {
		...
		Shell parent1 = getParent();
		Display display1 = parent1.getDisplay();
		shell = new Shell(parent1, SWT.DIALOG_TRIM | SWT.RESIZE | SWT.MIN
				| SWT.MAX);
		props.setLook(shell);
		setShellImage(shell, input);

		ModifyListener lsMod1 = new ModifyListener() {
			@Override
		...
		formLayout1.marginWidth = Const.FORM_MARGIN;
		formLayout1.marginHeight = Const.FORM_MARGIN;

		shell.setLayout(formLayout1);
		shell.setText("TESTE");
